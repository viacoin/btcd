...
type NotificationHandlers struct {
	...
	// result of a rescan request, due to how viad may send various rescan
...
func (c *Client) handleNotification(ntfn *rawNotification) {
	...
	case btcjson.BtcdConnectedNtfnMethod:
		...
		if err != nil {
			log.Warnf("Received invalid viad connected "+
				"notification: %v", err)
			return
		}
...
//
// NOTE: This is a viad extension ported from github.com/decred/dcrrpcclient
...
// parseBtcdConnectedNtfnParams parses out the connection status of viad
// and btcwallet from the parameters of a viadconnected notification.
...
//
// NOTE: This is a viad extension and requires a websocket connection.
