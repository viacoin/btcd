...
/*
viad is a full-node bitcoin implementation written in Go.

The default options are sane for most users.  This means viad will work 'out of
...
parsed when viad starts up.  By default, the configuration file is located at
~/.viad/viad.conf on POSIX-style operating systems and %LOCALAPPDATA%\viad\viad.conf
...
Application Options:
  ...
  -a, --addpeer=            Add a peer to connect with at startup
      ...
      --listen=             Add an interface/port to listen for connections
                            (default all interfaces port: 5223, testnet: 15223)
  ...
  -P, --rpcpass=            Password for RPC connections
      ...
      --rpclisten=          Add an interface/port to listen for RPC connections
                            (default port: 5224, testnet: 15224)
