...
reason, the viad suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire viad
...
One of the major design goals of all core viad packages is to aim for complete
...
commits](https://github.com/viacoin/viad/commits/master) for examples of
commit messages.
...
contributions.  This is how to get your changes into viad.
...
Rejoice as you will now be listed as a [contributor](https://github.com/viacoin/viad/graphs/contributors)!
...
[ISC license](https://github.com/viacoin/viad/blob/master/LICENSE).  This is
the same license as all of the code in the viad suite.
