...
func TestVersion(t *testing.T) {
	...
	tcpAddrMe := &net.TCPAddr{IP: net.ParseIP("127.0.0.1"), Port: 5223}
	me := NewNetAddress(tcpAddrMe, SFNodeNetwork)
	tcpAddrYou := &net.TCPAddr{IP: net.ParseIP("192.168.0.1"), Port: 5223}
...
func TestVersionOptionalFields(t *testing.T) {
	...
	uaVersion.UserAgent = "/viadtest:0.0.1/"
...
var baseVersionEncoded = []byte{
	...
	0x14, 0x67, // Port 5223 in big-endian
	...
	0x2f, 0x76, 0x69, 0x61, 0x64, 0x74, 0x65, 0x73,
