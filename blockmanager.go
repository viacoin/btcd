...
type PeerNotifier interface {
	...
	TransactionConfirmed(tx *viautil.Tx)
}
...
func (b *blockManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*viautil.Block)
		if !ok {
...
// processed.
func (b *blockManager) QueueTx(tx *viautil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (b *blockManager) QueueBlock(block *viautil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
func (b *blockManager) ProcessBlock(block *viautil.Block, flags blockchain.BehaviorFlags) (bool, error) {
