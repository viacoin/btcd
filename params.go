...
// reference implementation because viad does not handle wallet requests.  The
// separate wallet process listens on the well-known port and forwards requests
// it does not handle on to viad.  This approach allows the wallet process
...
// time of writing, viad currently places blocks for testnet version 3 in the
