...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*viautil.Block, error) {
	...
	blocks := make([]*viautil.Block, 0, 256)
	genesis := viautil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
