...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr viautil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*viautil.Tx, error) {
...
func CreateBlock(prevBlock *viautil.Block, inclusionTxs []*viautil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr viautil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*viautil.Block, error) {
	...
	blockTxns := []*viautil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := viautil.NewBlock(&block)
