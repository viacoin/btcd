...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*viautil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *viautil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *viautil.Block) error {
