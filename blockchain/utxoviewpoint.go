...
func (view *UtxoViewpoint) AddTxOuts(tx *viautil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *viautil.Tx, blockHeight int32, stxos *[]spentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *viautil.Block, stxos *[]spentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(block *viautil.Block, stxos []spentTxOut) error {
...
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *viautil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *viautil.Tx) (*UtxoViewpoint, error) {
	b.chainLock.RLock()
