...
// txouts.
func dbFetchSpendJournalEntry(dbTx database.Tx, block *viautil.Block, view *UtxoViewpoint) ([]spentTxOut, error) {
...
func (b *BlockChain) createChainState() error {
	...
	genesisBlock := viautil.NewBlock(b.chainParams.GenesisBlock)
...
func (b *BlockChain) initChainState() error {
	...
	err := b.db.View(func(dbTx database.Tx) error {
		...
		blockWeight := uint64(GetBlockWeight(viautil.NewBlock(&block)))
...
// raw block for the provided node, deserialize it, and return a viautil.Block
// with the height set.
func dbFetchBlockByNode(dbTx database.Tx, node *blockNode) (*viautil.Block, error) {
...
func (b *BlockChain) BlockByHeight(blockHeight int32) (*viautil.Block, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHash(hash *chainhash.Hash) (*viautil.Block, error) {
