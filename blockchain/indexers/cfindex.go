...
func storeFilter(dbTx database.Tx, block *viautil.Block, f *gcs.Filter,
	extended bool) error {
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *viautil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *viautil.Block,
	view *blockchain.UtxoViewpoint) error {
