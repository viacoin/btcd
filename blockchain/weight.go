...
func GetBlockWeight(blk *viautil.Block) int64 {
...
func GetTransactionWeight(tx *viautil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *viautil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint,
