...
(http://godoc.org/github.com/viacoin/viad/peer)
...
```bash
$ go get -u github.com/viacoin/viad/peer
```

## Examples

* [New Outbound Peer Example]
  (https://godoc.org/github.com/viacoin/viad/peer#example-package--NewOutboundPeer)  
